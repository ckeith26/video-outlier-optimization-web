  ...
  return (
    <div className="App">
      ...
      <Section title="Conclusion">
        <p>
          Our study bridges the gap by revealing that outliers really matter in video classification. In particular, our analysis shows that while outliers can reduce model performances, removing large-scale outliers can downplay overall performances. This calls for further investigations on the optimal threshold for outlier removal to boost video classification performances at scale.
        </p>
      </Section>
      </div>
    </div>
